...
//        System.out.println(Calculator.squareRootExtraction(169));
        ...
        assertThat(Calculator.calculatingDiscount(5000, 10)).isEqualTo(4500); //положительное тестирование
        assertThatThrownBy(() -> Calculator.calculatingDiscount(-5000, 10)).isInstanceOf(ArithmeticException.class).hasMessage("Цена не может быть меньше 0"); //тестирование при отрицательной цене
        assertThatThrownBy(() ->Calculator.calculatingDiscount(5000, -10)).isInstanceOf(ArithmeticException.class).hasMessage("Скидка не может быть меньше нуля"); //тестирование при отрицательной скидке
        assertThatThrownBy(() -> Calculator.calculatingDiscount(5000, 125)).isInstanceOf(ArithmeticException.class).hasMessage("Скидка не может быть больше 100"); //тестирование при скидке более 100%
